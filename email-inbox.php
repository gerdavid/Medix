                            ...
                            <div class="card-body">
                                <div class="card-content">
                                    ...
                                    <div class="inbox-leftbar">
                                        <a class="btn btn-danger btn-block waves-effect waves-light" href="">Inbox</a>
<?php
$sql="SELECT * FROM members WHERE email='$email' " ;
   ...
   $sql33="SELECT * FROM message WHERE receiver_id='$mine' AND status = '0' GROUP BY date" ;
   $query33=$conn->query($sql33);
   $rownew=mysqli_num_rows($query33);
?>
                                         <div class="mail-list mt-4">
<a href="#" class="list-group-item border-0 text-danger"><i class="mdi mdi-inbox font-18 align-middle mr-2"></i><b>Inbox</b><span class="label label-danger float-right ml-2">NEW: <?php echo $rownew ;?></span></a>
  ...
  <div class="col-mail col-mail-1">
                                                                    ...
                                                                    <p class="title"><font color="blue">From</font></p><span class=""></span>
                                                                </div>
                                                                <div class="col-mail col-mail-2">
                                                                    <div class="subject"><font color="blue">Subject</font>
                                                                       <!-- <span class="teaser">@LucasKriebel - Very cool :) Nicklas, You have a new direct message.</span>-->
                                                                    </div>
                                                                    <div class="date"><font color="blue">Date</font></div>
                                                                </div>
                                                        ...
                                                        ?>
                                                            <a href="email-read.php?id=<?php echo $id ;?>">
                                                                <div class="col-mail col-mail-1">
                                                                    ...
                                                                    <p class="title"><?php echo $sender;?></p><span class=""></span>
                                                                </div>
                                                                <div class="col-mail col-mail-2">
