                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="media mb-4 mt-1">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <small class="text-muted">To: <?php echo $sender_e;?></small>
                                                </div>
                                            </div>
                                            <p><?php echo $body;?></p>
                                            <hr/>
...
while($row3=$que3->fetch_assoc()){
    //$imageURL = 'xrays/'.$row3["image"];
    $imageURL = 'dist/data/'.$email.'/'.$row3["image"];
$image=$row3['image'];
$id1=$row3['id'];

     echo '<form action="dist/" method="POST" enctype="multipart/form-data">
                                    <button type="submit" class="btn btn-info" name="xray" value='.$imageURL.'>'.$image.'</button><br><br>
