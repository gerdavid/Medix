        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Write Report</h3> </div>
                                ...
                                <div class="basic-form">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                            <label>X-Ray ID:</label>
                                            <input type="text" name="xray" class="form-control" placeholder="">
                                        </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="diagnosis" rows="15" placeholder=""></textarea>
                                        </div>
...
$image1=$_POST['image'];
      ...
      $insert = "INSERT INTO reports (name,phone,xray,type,diagnosis,age,hospital,date,memberid,sender,image) VALUES ('$name','$phone','$xray','$type','$diagnosis','$age','$hospital',now(),'$member','$sender1','$image1')";
   $query1=$conn->query($insert);
            if($query1){
echo "<script>alert('Successfully Added'); window.location = './report.php';</script>";
       
    }else{
            echo"<script>alert('Error Adding Try Again!')</script>";
            }
